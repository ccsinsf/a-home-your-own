...
def load_histdata():
    ...
    for row in open("seed_data/final_all_cities_historical.csv"):
        row = row.rstrip()
        city_name, state, date, hist_price_jan_2009, hist_price_feb_2009, hist_price_mar_2009, hist_price_apr_2009,
        ...
        hist_price_nov_2012, hist_price_dec_2012, hist_price_jan_2013, hist_price_feb_2013, hist_price_mar_2013, hist_price_apr_2013,
        hist_price_may_2013, hist_price_jun_2013, hist_price_jul_2013, hist_price_aug_2013, hist_price_sep_2013, hist_price_oct_2013,
